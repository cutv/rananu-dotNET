...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
        ...
        public delegate void ApplicationUpdateAvaiableEventHandler();
        public static event ApplicationUpdateAvaiableEventHandler ApplicationUpdateAvaiableEvent;

        public delegate void BindIPEndPointEventHandler(Uri uri);
        public static event BindIPEndPointEventHandler BindIPEndPointEvent;
            ...
            else
            {
                if (result is UpdateInfoEventArgs args)
                {
                    ...
                    else
                    {
                        ...
                        {
                            ApplicationUpdateAvaiableEvent();
        ...
        {
            if (BindIPEndPointEvent != null)
                BindIPEndPointEvent(uri);
